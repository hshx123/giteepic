...
if [ $1 = 'cdn' ]
	...
	master_url='https://gh.66ccff.work/https://gh.66ccff.work/https://github.com/helloxz/ccaa/archive/master.zip'
	ccaa_web_url='http://soft.xiaoz.top/linux/ccaa_web.tar.gz'
	else
	aria2_url='https://gh.66ccff.work/https://github.com/q3aql/aria2-static-builds/releases/download/v1.35.0/aria2-1.35.0-linux-gnu-64bit-build1.tar.bz2'
	filebrowser_url='https://gh.66ccff.work/https://github.com/filebrowser/filebrowser/releases/download/v2.0.16/linux-amd64-filebrowser.tar.gz'
	master_url='https://gh.66ccff.work/https://github.com/helloxz/ccaa/archive/master.zip'
...
function install_aria2(){
	...
	cd ./ccaa_tmp
	#yum -y update
	#安装aria2静态编译版本，来源于https://gh.66ccff.work/https://github.com/q3aql/aria2-static-builds/
	wget -c ${aria2_url}
